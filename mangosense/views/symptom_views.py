...
from mangosense.repositories.symptom_repository import(
    get_fallback_symptoms,
    get_symptoms_for_disease
)

#URL: GET /api/symptoms/?disease=<name>&plant_part=<leaf|fruit>
@api_view(['GET'])
#@permission_classes([AllowAny])
def get_disease_symptoms(request: Request) -> JsonResponse:
    ...
    symptoms = get_symptoms_for_disease(disease, plant_part)

    if not symptoms:
        symptoms = get_fallback_symptoms()
